...
def checkbox_example():
    ...
    if check_box.Value == 1:
        xl.Range("checkbox_output").Value2 = "CHECKED"
    else:
        xl.Range("checkbox_output").Value2 = "Click the check box"

@xl_macro
def scrollbar_example():
    xl = xl_app()
    scrollbar = xl.ActiveSheet.ScrollBars(xl.Caller)
    xl.Range("scrollbar_output").Value2 = scrollbar.Value
