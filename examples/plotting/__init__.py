...
def plot_mpl(enable,
    ...
    try:
        ...
        mpl_plot.plot(xs, ys, xlabel, ylabel, title, width, height, zoom, allow_html, allow_svg)
...
def plot_plotly(enable,
    ...
    try:
        ...
        plotly_plot.plot(xs, ys, xlabel, ylabel, title, width, height, zoom, allow_html, allow_svg)
...
def plot_pandas(enable,
    ...
    try:
        ...
        pandas_plot.plot(xs, ys, xlabel, ylabel, title, width, height, zoom, allow_html, allow_svg)
...
def plot_seaborn(enable,
    ...
    try:
        ...
        seaborn_plot.plot(xs, ys, xlabel, ylabel, title, width, height, zoom, allow_html, allow_svg)
...
def plot_bokeh(enable,
    ...
    try:
        ...
        bokeh_plot.plot(xs, ys, xlabel, ylabel, title, width, height, zoom, allow_html, allow_svg)
...
def plot_altair(enable,
    ...
    if not enable:
        return "[Altair Disabled]"
    try:
        from . import altair_plot
        altair_plot.plot(xs, ys, xlabel, ylabel, title, width, height, zoom, allow_html, allow_svg)
