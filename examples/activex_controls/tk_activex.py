"""
PyXLL Examples: Tk ActiveX control
...
class ExampleTkFrame(tk.Frame):
    ...
    def init_window(self):
        ...
        if Image is not None:
            image_path = os.path.join(os.path.dirname(__file__), "..", "ribbon", "icons", "tk.png")
        ...
        label = tk.Label(self, text="Tk ActiveX Control")
...
def show_tk_activex():
    """Create a Tk window and embed it in Excel as an ActiveX control."""
    ...
    create_activex_control(window,
                           name="tk_activex_example",
                           top=50,
                           left=25,
                           width=250,
                           height=300)
